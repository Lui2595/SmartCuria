    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky1 ftco-navbar-light" id="ftco-navbar">
		<div class="container d-flex align-items-center">
            <div class="new-nav d-none d-lg-block" >
                   <a href="index.php"> <img class="img-fluid" src="images/logo.png" style="width: 8vw;margin-right:5vw" alt="" ></a>
                        ...
                        <div class="row justify-content-center mb-4 pt-md-4" style="align-content: center;">
                            <div class="col-md-10 heading-section ftco-animate " style="color:black">
                                ...
                                <div class="d-flex about robotom">
                                    ...
                                    <h3>Be one of the first to be able to enter this new stage of digital investments, 
                                        with unique information and the possibility of being able to talk with Curia members by first-hand, 
                                        not to mention the surprises and advantages you will have at this stage.</h3>

                                </div>
                                
                                <ul style="list-style-type: none;" class="robotom">
                                    <li><i class="bi bi-check2-circle"></i> Early access to Presale</li>
                                    <li><i class="bi bi-check2-circle"></i> Exclusive NFT when participating in the Presale</li>
                                    <li><i class="bi bi-check2-circle"></i> Primarch rank on discord channel</li>
                                    <li><i class="bi bi-check2-circle"></i> Send private messages to devs</li>
                                </ul>
                                <span class="robotom"> Already whitelisted:</span> <span class="robotom" id="Espacios"></span>
                                    </br>
